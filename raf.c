...
struct RandomArray * new_random_array_fatory(unsigned char size)
{
    if(NULL == raf_random_array_singlton)
    {
        ...
        for(;random_array->random_char_array_index < random_array->size;random_array->random_char_array_index++)
        {
            random_array->duplicate_select_array[random_array->random_char_array_index] = 
            random_array->track_array[random_array->random_char_array_index] = 
            random_array->random_char_array[random_array->random_char_array_index] = 0;
        }
